...
{
    public partial class ql_tk : Form
    {
        public ql_tk()
        {
            InitializeComponent();
        ...
        public void load()
        {
            ...
            try
            {
                string sql = "select tk,convert(varchar(32),hashbytes('md5',mk),2) from truongkhoa";
        ...
        private void ql_tk_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        ketnoi.Open();
                        string st = "select count(*) from truongkhoa where tk='" + txbAcc.Text + "'";
                        int i = 0;
                        ...
                        {
                            string s = "insert into truongkhoa values('" + txbAcc.Text.Trim() + "','" + txbPas.Text.Trim() + "')";
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            string s = "update truongkhoa set mk='" + txbPas.Text + "' where tk='" + txbAcc.Text + "'";
                            truyxuat.thaotac(s);
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        string s = "delete from truongkhoa where tk='" + txbAcc.Text + "'";
                        truyxuat.thaotac(s);
        ...
        private void txbPas_Click(object sender, EventArgs e)
        {
         
        }

        private void txbPas_MouseHover(object sender, EventArgs e)
        {
