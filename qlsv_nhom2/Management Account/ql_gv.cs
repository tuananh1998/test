...
namespace qlsv_nhom2
{
    public partial class ql_gv : Form
    {
        ...
        public void load()
        {
            ...
            try
            {
                string sql = "select tk,convert(varchar(32),hashbytes('md5',mk),2) from giaovien";
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        ketnoi.Open();
                        string st = "select count(*) from giaovien where tk='" + txbAcc.Text + "'";
                        int i = 0;
                        ...
                        {
                            string s = "insert into giaovien values('" + txbAcc.Text.Trim() + "','" + txbPas.Text.Trim() + "')";
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            string s = "update giaovien set mk='" + txbPas.Text + "' where tk='" + txbAcc.Text + "'";
                            truyxuat.thaotac(s);
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        string s = "delete from giaovien where tk='" + txbAcc.Text + "'";
                        truyxuat.thaotac(s);
