...
namespace qlsv_nhom2
{
    public partial class frmain : Form
    {
        ...
        public frmain(string loai)
        {
            InitializeComponent();
            pq = loai;
            label2.Text = "CHÀO MỪNG "+ loai.ToUpper() + " ĐẾN VỚI CHƯƠNG TRÌNH CHÍNH" ;
        }
        ...
        private void khoaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Information.infor_khoa f = new Information.infor_khoa();
            f.ShowDialog();
        }
        ...
        {
            Information.infor_cs f = new Information.infor_cs();
            f.ShowDialog();
        }

        private void điểmToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Information.infor_Diem f = new Information.infor_Diem();
            f.ShowDialog();
        }
        ...
        private void mônHọcToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Information.infor_monh f = new Information.infor_monh();
            f.ShowDialog();
        }

        private void sinhViênToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Information.infor_sv f = new Information.infor_sv();
            f.ShowDialog();
        }

        private void lớpToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Information.infor_lop f = new Information.infor_lop();
            f.ShowDialog();
        }

        private void giáoViênToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Information.infor_gv f = new Information.infor_gv();
            f.ShowDialog();
        }

        private void timer2_Tick(object sender, EventArgs e)
        {
            label3.Text = DateTime.Now.Day + "-"+ DateTime.Now.Month + "-"+ DateTime.Now.Year;
            label1.Text = "Time: "+DateTime.Now.Hour + ":" + DateTime.Now.Minute + ":" + DateTime.Now.Second;
        ...
        {
            menuToolStripMenuItem.Text = "System";
