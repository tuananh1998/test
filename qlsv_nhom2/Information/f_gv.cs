...
{
    public partial class f_gv : Form
    {
        public f_gv()
        {
            InitializeComponent();
        ...
        private void f_gv_Load(object sender, EventArgs e)
        {
                ...
                if(txbAcc.Text.Trim() != ""&& txbPas.Text.Trim() != ""&& textBox1.Text.Trim() != ""&& dateTimePicker1.Text.Trim() != ""&& textBox3.Text.Trim() != ""&& textBox4.Text.Trim() != "")
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            string s = "insert into ttgiaovien values('" + txbAcc.Text.Trim() + "',N'" + txbPas.Text.Trim() + "',N'" + textBox1.Text.Trim() + "',N'" + dateTimePicker1.Text.Trim() + "','" + textBox3.Text.Trim() + "',N'" + textBox4.Text.Trim() + "')";
                ...
                if (txbAcc.Text.Trim() != "" && txbPas.Text.Trim() != "" && textBox1.Text.Trim() != "" && dateTimePicker1.Text.Trim() != "" && textBox3.Text.Trim() != "" && textBox4.Text.Trim() != "")
                {
                    ...
                    else
                    {
                        try
                        {
                            ...
                            string s = "update ttgiaovien set tengv=N'" + txbPas.Text + "',gioitinh=N'" + textBox1.Text + "',ngaysinh='" + dateTimePicker1.Text + "',sdt=N'" + textBox3.Text + "',diachi=N'" + textBox4.Text + "' where magv='" + txbAcc.Text + "'";
                            truyxuat.thaotac(s);
